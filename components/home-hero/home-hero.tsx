...
// Day/night cycle — parked while the hero runs the scroll-scrubbed video.
//
...
// Stand-in while the day/night cycle above is parked: the video is dark, so the night
// styling (cooler glow, deeper shadow) reads better over it.
const isDay = false;

/** Hero with a scroll-scrubbed video backdrop — scrolling runs the footage forward and back. */
    ...
    <>
      ...
      <main id="hero" ref={heroRef} className="relative h-[100dvh] md:h-[280vh]">
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          {/* Ground layer — removed so the video fills the hero edge to edge. */}
